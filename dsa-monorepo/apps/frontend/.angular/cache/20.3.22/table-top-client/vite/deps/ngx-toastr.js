...
ToastContainerDirective.ɵfac = function ToastContainerDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || ToastContainerDirective)(ɵɵdirectiveInject(ElementRef));
};
ToastContainerDirective.ɵdir = ɵɵdefineDirective({
...
var Overlay = class {
  constructor() {
    ...
    this._componentFactoryResolver = inject(ComponentFactoryResolver$1);
...
ToastrService.ɵfac = function ToastrService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || ToastrService)(ɵɵinject(TOAST_CONFIG), ɵɵinject(Overlay), ɵɵinject(Injector), ɵɵinject(DomSanitizer), ɵɵinject(NgZone));
};
...
Toast.ɵfac = function Toast_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || Toast)(ɵɵdirectiveInject(ToastrService), ɵɵdirectiveInject(ToastPackage), ɵɵdirectiveInject(NgZone));
};
...
ToastrModule.ɵmod = ɵɵdefineNgModule({
  type: ToastrModule,
  imports: [Toast],
  exports: [Toast]
});
ToastrModule.ɵinj = ɵɵdefineInjector({
  imports: [Toast]
});
(() => {
...
ToastrComponentlessModule.ɵmod = ɵɵdefineNgModule({
  type: ToastrComponentlessModule
});
ToastrComponentlessModule.ɵinj = ɵɵdefineInjector({});
(() => {
...
ToastNoAnimation.ɵfac = function ToastNoAnimation_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || ToastNoAnimation)(ɵɵdirectiveInject(ToastrService), ɵɵdirectiveInject(ToastPackage), ɵɵdirectiveInject(ApplicationRef));
};
ToastNoAnimation.ɵcmp = ɵɵdefineComponent({
...
ToastNoAnimationModule.ɵmod = ɵɵdefineNgModule({
  type: ToastNoAnimationModule,
  imports: [ToastNoAnimation],
  exports: [ToastNoAnimation]
});
ToastNoAnimationModule.ɵinj = ɵɵdefineInjector({
  imports: [ToastNoAnimation]
});
(() => {
